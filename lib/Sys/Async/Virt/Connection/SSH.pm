...
class Sys::Async::Virt::Connection::SSH v0.1.8;
...
use Protocol::Sys::Virt::UNIXSocket v11.9.0; # imports socket_path
use Protocol::Sys::Virt::URI v11.9.0; # imports parse_url
