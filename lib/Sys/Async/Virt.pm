...
use Protocol::Sys::Virt::KeepAlive v12.7.0;
use Protocol::Sys::Virt::Remote v12.7.0;
use Protocol::Sys::Virt::Transport v12.7.0;
use Protocol::Sys::Virt::URI v12.7.0; # imports parse_url

use Sys::Async::Virt::Connection::Factory v0.6.7;
use Sys::Async::Virt::Domain v0.6.7;
use Sys::Async::Virt::DomainCheckpoint v0.6.7;
use Sys::Async::Virt::DomainSnapshot v0.6.7;
use Sys::Async::Virt::Network v0.6.7;
use Sys::Async::Virt::NetworkPort v0.6.7;
use Sys::Async::Virt::NwFilter v0.6.7;
use Sys::Async::Virt::NwFilterBinding v0.6.7;
use Sys::Async::Virt::Interface v0.6.7;
use Sys::Async::Virt::StoragePool v0.6.7;
use Sys::Async::Virt::StorageVol v0.6.7;
use Sys::Async::Virt::NodeDevice v0.6.7;
use Sys::Async::Virt::Secret v0.6.7;

use Sys::Async::Virt::Callback v0.6.7;
use Sys::Async::Virt::Stream v0.6.7;
...
use constant {
    ...
    DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_CONNECTED       => 1,
    DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_DISCONNECTED    => 2,
    DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_UNKNOWN        => 0,
    DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_DOMAIN_STARTED => 1,
    DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_CHANNEL        => 2,
    ...
    DOMAIN_EVENT_ID_VCPU_REMOVED                         => 28,
    DOMAIN_EVENT_ID_CHANNEL_LIFECYCLE                    => 29,
...
The reference LibVirt version of this module is v12.7.0. This means
...
The module can run against any version of LibVirt newer than v12.7.0;
...
=item DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_CONNECTED

=item DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_DISCONNECTED

=item DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_UNKNOWN

=item DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_DOMAIN_STARTED

=item DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_CHANNEL
...
=item DOMAIN_EVENT_ID_VCPU_REMOVED

=item DOMAIN_EVENT_ID_CHANNEL_LIFECYCLE
