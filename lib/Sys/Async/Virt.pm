...
use Protocol::Sys::Virt::KeepAlive v12.1.0;
use Protocol::Sys::Virt::Remote v12.1.0;
use Protocol::Sys::Virt::Transport v12.1.0;
use Protocol::Sys::Virt::URI v12.1.0; # imports parse_url

use Sys::Async::Virt::Connection::Factory v0.6.1;
use Sys::Async::Virt::Domain v0.6.1;
use Sys::Async::Virt::DomainCheckpoint v0.6.1;
use Sys::Async::Virt::DomainSnapshot v0.6.1;
use Sys::Async::Virt::Network v0.6.1;
use Sys::Async::Virt::NetworkPort v0.6.1;
use Sys::Async::Virt::NwFilter v0.6.1;
use Sys::Async::Virt::NwFilterBinding v0.6.1;
use Sys::Async::Virt::Interface v0.6.1;
use Sys::Async::Virt::StoragePool v0.6.1;
use Sys::Async::Virt::StorageVol v0.6.1;
use Sys::Async::Virt::NodeDevice v0.6.1;
use Sys::Async::Virt::Secret v0.6.1;

use Sys::Async::Virt::Callback v0.6.1;
use Sys::Async::Virt::Stream v0.6.1;
...
The reference LibVirt version of this module is v12.1.0. This means
...
The module can run against any version of LibVirt newer than v12.1.0;
