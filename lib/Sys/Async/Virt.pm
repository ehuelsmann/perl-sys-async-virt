...
# ENTRYPOINT: REMOTE_PROC_CONNECT_DEREGISTER_CLOSE_CALLBACK
async sub close {
    my ($self) = @_;
    await $self->_call( $remote->PROC_CONNECT_DEREGISTER_CLOSE_CALLBACK );
...
=item * REMOTE_PROC_CONNECT_UNREGISTER_CLOSE_CALLBACK
