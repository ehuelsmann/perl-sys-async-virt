...
requires 'Protocol::Sys::Virt' => '11.7.0';
requires 'Protocol::Sys::Virt::KeepAlive' => '11.7.0';
requires 'Protocol::Sys::Virt::Remote' => '11.7.0';
requires 'Protocol::Sys::Virt::Remote::XDR' => '11.7.0';
requires 'Protocol::Sys::Virt::UNIXSocket' => '11.7.0';
requires 'Protocol::Sys::Virt::URI' => '11.7.0';
